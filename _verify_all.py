import paramiko, subprocess, yaml, json, base64, os
servers = [
    ("43.207.152.47", "JP", "sarEBA97@jh.dxclouds.com", "JP"),
    ("13.212.37.11", "SG", "jbfCMP75@jh.dxclouds.com", "SG"),
    ("43.249.174.222", "HK", "2aKf9Xt!4U.gOywfci", "HK"),
]
