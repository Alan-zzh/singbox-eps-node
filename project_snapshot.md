...
- 版本：v4.3.0
- 状态：正常运行
- 修复记录：2026-05-07 修复CF_DOMAIN错误(us→sg)、MTU 9001→1500、UDP缓冲区优化
...
- 版本：v4.3.0
- 状态：正常运行
- 修复记录：2026-05-07 修复.env注释导致ValueError、空密码导致singbox无法启动、MTU 9001→1500、UDP缓冲区优化
